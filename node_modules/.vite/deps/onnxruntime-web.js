...
var Pr = O(() => {
  ...
  ((e) => {
    ...
    ((t) => {
      ...
      ((n) => {
        let r;
        ((P) => (P[P.UNDEFINED = 0] = "UNDEFINED", P[P.FLOAT = 1] = "FLOAT", P[P.INT = 2] = "INT", P[P.STRING = 3] = "STRING", P[P.TENSOR = 4] = "TENSOR", P[P.GRAPH = 5] = "GRAPH", P[P.FLOATS = 6] = "FLOATS", P[P.INTS = 7] = "INTS", P[P.STRINGS = 8] = "STRINGS", P[P.TENSORS = 9] = "TENSORS", P[P.GRAPHS = 10] = "GRAPHS", P[P.SPARSE_TENSOR = 11] = "SPARSE_TENSOR", P[P.SPARSE_TENSORS = 12] = "SPARSE_TENSORS"))(r = n.AttributeType || (n.AttributeType = {}));
      })(o = t.fbs || (t.fbs = {}));
    })(i = e.experimental || (e.experimental = {}));
  })(F || (F = {}));
  ((e) => {
    let i;
    ((t) => {
      ...
      ((n) => {
        let r;
        ((l) => (l[l.UNKNOWN = 0] = "UNKNOWN", l[l.VALUE = 1] = "VALUE", l[l.PARAM = 2] = "PARAM"))(r = n.DimensionValueType || (n.DimensionValueType = {}));
      })(o = t.fbs || (t.fbs = {}));
    })(i = e.experimental || (e.experimental = {}));
  })(F || (F = {}));
  ((e) => {
  ...
  ((e) => {
    ...
    ((t) => {
      ...
      ((n) => {
        let r;
        ((u) => (u[u.Primitive = 0] = "Primitive", u[u.Fused = 1] = "Fused"))(r = n.NodeType || (n.NodeType = {}));
      })(o = t.fbs || (t.fbs = {}));
    })(i = e.experimental || (e.experimental = {}));
  })(F || (F = {}));
  ((e) => {
    ...
    ((t) => {
      ...
      ((n) => {
        let r;
        ((f) => (f[f.NONE = 0] = "NONE", f[f.tensor_type = 1] = "tensor_type", f[f.sequence_type = 2] = "sequence_type", f[f.map_type = 3] = "map_type"))(r = n.TypeInfoValue || (n.TypeInfoValue = {}));
      })(o = t.fbs || (t.fbs = {}));
    })(i = e.experimental || (e.experimental = {}));
  })(F || (F = {}));
  ((e) => {
...
`);
    ...
    bindUniforms(e, o, t) {
      ...
      for (let { name: s, type: a, location: u, arrayLength: l } of e) {
        let f = (_a = o.find((p) => p.name === s)) == null ? void 0 : _a.data;
...
`, "%p": (_) => 0 <= _.Va && 12 > _.Va ? "AM" : "PM", "%S": (_) => E(_.gb, 2), "%t": () => "	", "%u": (_) => _.Qa || 7, "%U": (_) => E(Math.floor((_.Sa + 7 - _.Qa) / 7), 2), "%V": (_) => {
    ...
    var Vd = [vo, ra, la, da, ha, ga, ya, xa, Ta, wa, va, Ia, _a2, Oa, Sa, Aa, Da, La, Fa, Ca, Na, Ra, Ga, Ma], U = function() {
      ...
      return Ze || (Ze = u.locateFile ? Ot("ort-wasm-simd-threaded.wasm") ? "ort-wasm-simd-threaded.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.wasm", P) : P + "ort-wasm-simd-threaded.wasm" : new URL("ort-wasm-simd-threaded.wasm", import.meta.url).href), function(g, x) {
        var I = Ze;
...
var Vr = O(() => {
  ...
  var _a, _b2;
  ro();
  br = false ? void 0 : import.meta.url ?? (typeof document < "u" ? (_a = document.currentScript) == null ? void 0 : _a.src : typeof self < "u" ? (_b2 = self.location) == null ? void 0 : _b2.href : void 0), _g = typeof location > "u" ? void 0 : location.origin, Og = (i, e) => {
    try {
      let o = e ?? br;
...
var Xe = O(() => {
  ...
  qi = false, co = false, Wp = false, Pg = () => {
    ...
    let r = i.wasmPaths, n = typeof r == "string" ? r : void 0, s = r == null ? void 0 : r.mjs, a = (s == null ? void 0 : s.href) ?? s, u = r == null ? void 0 : r.wasm, l = (u == null ? void 0 : u.href) ?? u, f = i.wasmBinary, [p, d] = await zp(a, n, o > 1), y = false, w = [];
...
var zi = O(() => {
  ...
  Bg = (i, e) => {
    ...
    try {
      ...
      let [p, d] = Fg(n), y = !!(e == null ? void 0 : e.enableGraphCapture), w = [], v = [], S = [];
      for (let A = 0; A < p; A++) {
      ...
      r._free(o), s !== 0 && r._OrtReleaseSessionOptions(s), u.forEach((p) => r._free(p)), (_a = r.unmountExternalData) == null ? void 0 : _a.call(r);
    }
  }, so = (i) => {
    var _a;
    let e = gt(), o = yr.get(i);
    ...
    try {
      ...
      for (let Z = 0; Z < v; Z++) {
        ...
        try {
          ...
          lt = Kp(Te);
          let Ze = p == null ? void 0 : p.outputPreferredLocations[t[Z]];
          if (lt === "string") {
